        ...
        <section id="inicio" ref={heroRef} className={styles.hero}>
          <div className={styles.heroInner}>
            <div className={styles.heroCopy}>
              ...
              <div className={styles.mobileHeroProduct}><Image src="/hero-pv-link-embaixador.jpg" alt="Sabão Líquido e Amaciante Bryza de 5 litros" width={336} height={255} priority /></div>

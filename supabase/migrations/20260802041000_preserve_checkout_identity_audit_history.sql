-- Mantém o fingerprint temporário no histórico de identidade em vez de apagá-lo.
-- A tabela é append-only e seu gatilho de auditoria proíbe DELETEs destrutivos.
...
COMMENT ON FUNCTION public.fn_criar_agendamento_publico_kit(jsonb, jsonb, jsonb, uuid)
  IS 'Creates a Kit Bryza scheduling, reuses legacy customers and preserves append-only identity audit history.';
